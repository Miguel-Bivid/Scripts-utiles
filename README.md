...
| Revisión de la vulnerabilidad Dirty Frag | `curl -fsSL https://raw.githubusercontent.com/Miguel-Bivid/Scripts-utiles/refs/heads/main/DirtyFrag2-check.py -o DirtyFrag2-check.py`
`chmod +x DirtyFrag2-check.py`
`./DirtyFrag2-check.py` |
